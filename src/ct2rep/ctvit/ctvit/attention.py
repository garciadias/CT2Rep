...
class Attention(nn.Module):
    ...
    def forward(self, x, mask=None, context=None, attn_bias=None):
        batch, device, _ = x.shape[0], x.device, x.dtype
...
class AlibiPositionalBias(nn.Module):
    ...
    def _get_slopes(heads):
        ...
        extended_slopes = get_slopes_power_of_2(2 * closest_power_of_2)[0::2][: heads - closest_power_of_2]
        return slopes_power_of_2 + extended_slopes
